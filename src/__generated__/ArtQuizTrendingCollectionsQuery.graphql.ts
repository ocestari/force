/**
 * @generated SignedSource<<a818235d08b69f3d2378e448e14f39a4>>
...
export type ArtQuizTrendingCollectionsQuery$variables = {};
export type ArtQuizTrendingCollectionsQuery$data = {
  readonly viewer: {
    readonly " $fragmentSpreads": FragmentRefs<"ArtQuizTrendingCollections_viewer">;
  } | null;
};
export type ArtQuizTrendingCollectionsQuery = {
  response: ArtQuizTrendingCollectionsQuery$data;
  variables: ArtQuizTrendingCollectionsQuery$variables;
};
...
return {
  ...
  "params": {
    "cacheID": "e94ae2de00dd8659644441a42246befe",
    "id": null,
    "metadata": {},
    "name": "ArtQuizTrendingCollectionsQuery",
    "operationKind": "query",
...
(node as any).hash = "c1740b74c7cb51a97731bb713d164f66";
