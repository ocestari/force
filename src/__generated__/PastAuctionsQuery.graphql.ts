/**
 * @generated SignedSource<<4a78eed4065ea470684e89a4e9256a93>>
...
export type PastAuctionsQuery$variables = {
  after?: string | null;
  first: number;
};
export type PastAuctionsQuery$data = {
  readonly viewer: {
    readonly " $fragmentSpreads": FragmentRefs<"PastAuctions_viewer">;
  } | null;
};
export type PastAuctionsQuery = {
  response: PastAuctionsQuery$data;
  variables: PastAuctionsQuery$variables;
};
...
return {
  ...
  "params": {
    "cacheID": "fac3df39e1028611a73326150f7333ea",
    "id": null,
    "metadata": {},
    "name": "PastAuctionsQuery",
    "operationKind": "query",
