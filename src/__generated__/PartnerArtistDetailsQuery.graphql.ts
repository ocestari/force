/**
 * @generated SignedSource<<0c0df6b06f5aefcc644402c77cacc044>>
...
export type PartnerArtistDetailsQuery$variables = {
  artistId: string;
  partnerId: string;
};
export type PartnerArtistDetailsQuery$data = {
  readonly partner: {
...
export type PartnerArtistDetailsQuery = {
  response: PartnerArtistDetailsQuery$data;
  variables: PartnerArtistDetailsQuery$variables;
};
...
return {
  ...
  "params": {
    "cacheID": "88340e28eebb9ac3f6b694f0867610fc",
    "id": null,
    "metadata": {},
    "name": "PartnerArtistDetailsQuery",
    "operationKind": "query",
