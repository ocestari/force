/**
 * @generated SignedSource<<db8b85e626f979baf534260c3135d778>>
...
export type CollectionArtworksFilterQuery$variables = {
  input?: FilterArtworksInput | null;
  slug: string;
};
export type CollectionArtworksFilterQuery$data = {
  readonly collection: {
    readonly " $fragmentSpreads": FragmentRefs<"CollectionArtworksFilter_collection">;
  } | null;
};
export type CollectionArtworksFilterQuery = {
  response: CollectionArtworksFilterQuery$data;
  variables: CollectionArtworksFilterQuery$variables;
};
...
return {
  ...
  "params": {
    "cacheID": "b230e1b69bd0d0bca8bc165927b3174a",
    "id": null,
    "metadata": {},
    "name": "CollectionArtworksFilterQuery",
    "operationKind": "query",
